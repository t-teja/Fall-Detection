...
public class LocationService {
    ...
    private void requestLocationWithFusedProvider() {
        try {
            ...
            if (ActivityCompat.checkSelfPermission(context, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                ...
                com.google.android.gms.tasks.Task<android.location.Location> lastLocationTask = fusedLocationClient.getLastLocation();
                lastLocationTask
    ...
    private void requestFreshLocation() {
        try {
            ...
            if (ActivityCompat.checkSelfPermission(context, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                @SuppressWarnings("MissingPermission")
                com.google.android.gms.tasks.Task<Void> locationUpdateTask = fusedLocationClient.requestLocationUpdates(locationRequest, fusedLocationCallback, Looper.getMainLooper());
    ...
    private void requestLocationWithSystemProvider() {
        try {
            ...
            // Suppress lint warning as we already checked permissions above
            @SuppressWarnings("MissingPermission")
            ...
            try {
                ...
                if (currentLocationCallback != null) {
                    currentLocationCallback.onLocationError("Location permission denied");
                    currentLocationCallback = null;
                }
                return;
            }
    ...
    private void stopLocationUpdates() {
        ...
        try {
            ...
            try {
                ...
                Log.w(TAG, "Security exception stopping location updates", e);
            }
